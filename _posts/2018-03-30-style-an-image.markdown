...
{% raw %}
<iframe marginwidth="0" marginheight="0" style="border: 3px ridge #cccccc" width="600" height="auto" src="https://curious-yu.github.io/GoogleFrontEnd-Phase1-StyleAImage/"></iframe>
{% endraw %}
