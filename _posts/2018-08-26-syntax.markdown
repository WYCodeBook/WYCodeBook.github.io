...
🔍 [let and const](#let-and-const) 🔍 [Template Literals](#template-literals) 🔍 [Destructuring](#destructuring) 🔍 [Object Literal Shorthand](#object-literal-shorthand) 🔍 [Iteration](#iteration) 🔍 [spread operator](#spread-operator)
